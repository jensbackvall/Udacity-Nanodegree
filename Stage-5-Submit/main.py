...
#Below I render the page.
        self.render("index.html",comments = comments, lesson = lesson)
...
#This is where I get the content from the 'content' and field in my form. I have used the .strip() to strip away
#any comments that consist of only whitespace.
		comment_container.content = self.request.get('content').strip()
#If the comment is empty, I redirect to an error message, without trying to write the empty input to the database.
...
#And finally I redirect back to the main page and a thank you message.
